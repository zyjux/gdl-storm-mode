...
ev_ds = xr.Dataset(
    data_vars=dict(
        ricnn_ensemble_mu=(['model', 'test_sample', 'maj_min'], ricnn_ensemble_mu),
        ricnn_ensemble_sigma=(['model', 'test_sample', 'maj_min'], ricnn_ensemble_sigma),
    ),
    coords=dict(
